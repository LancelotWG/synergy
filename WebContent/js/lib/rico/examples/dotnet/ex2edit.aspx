...
<Rico:LiveGrid runat='server' id='ex8' formView='true' TableName='orders' DefaultSort='OrderID'>
<GridColumns>
  ...
  <Rico:Column runat='server' heading='Customer'      width='160' ColName='CustomerID'   EntryType='CL' InsertOnly='true' SelectCtl='CustomerTree' SelectSql="select CustomerID,CompanyName from customers order by CompanyName" />
  ...
  <Rico:Column runat='server' heading='City'        width='80'  ColName='ShipCity'       EntryType='B' />
  ...
  <Rico:Column runat='server' heading='Country'     width='90'  ColName='ShipCountry'    EntryType='N' control="new Rico.TableColumn.link('http://en.wikipedia.org/wiki/{11}','_blank')" />
</GridColumns>
</Rico:LiveGrid>
